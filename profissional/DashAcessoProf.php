                        ...
                        <div class="row">
                            <div class="col-md-6 dadosPessoais">
                                ...
                                <div class="info-row-complEnd">
                                    <div class="info-item"><?php echo htmlspecialchars($user['bairro'], ENT_QUOTES, 'UTF-8'); echo ",&nbsp"; ?></div>
                                    <div class="info-item"><?php echo htmlspecialchars($user['cidade'], ENT_QUOTES, 'UTF-8'); echo ",&nbsp"; ?></div>
                                    <div class="info-item"><?php echo htmlspecialchars($user['estado'], ENT_QUOTES, 'UTF-8'); echo ",&nbsp"; ?></div>
