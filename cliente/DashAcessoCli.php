...
// No trecho que processa o envio de comentários, adicione a fotoPerfil aos dados do comentário
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comentarioTexto'])) {
    ...
    try {
        $novoComentario = [
            ...
            'fotoPerfil' => $user['fotoPerfil'] ?? '../assets/img/perfil_cliente10.png', // Adiciona a URL da foto de perfil
            'titulo' => $titulo,
            'texto' => $texto,
            'avaliacao' => $avaliacao,
